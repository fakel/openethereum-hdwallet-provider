# openethereum-hdwallet-provider
HD Wallet-enabled Web3 provider. Use it to sign transactions for addresses derived from a 12 or 24 word mnemonic.

Based on @truffle/hdwallet-provider and modified to allow rpc calls to openethereum without skipCache flag.
## Install

```
$ npm install fakel/openethereum-hdwallet-provider
```
